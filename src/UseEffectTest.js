...
export function FunctionUseState() {
  ...
  return (
    <>
      ...
      <p>
        useState in Function updates with local environment Value,<br/>
        actual (fixed) at moment of function Call
      </p>
      <p>- - - - - - - - - - -</p>
    </>
  );
...
export class ClassThisState extends React.Component {
  ...
  render() {
    return (
      <>
        <p>
          this.state in Class update at the end of render cycle with last Value<br/>
          ! see ConsoleLog !
        </p>
